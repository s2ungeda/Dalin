object OrderBoardForm: TOrderBoardForm
  ...
  object PanelLeft: TPanel
    ...
    object PanelUnders: TPanel
      ...
      object ComboBoxUnderlyings: TComboBox
        ...
        OnKeyDown = ComboBoxUnderlyingsKeyDown
        OnKeyPress = ComboBoxUnderlyingsKeyPress
      end
    end
    ...
    object PageControl1: TPageControl
      ...
      object tabSpot: TTabSheet
        ...
        Caption = 'Spot'
        ImageIndex = 2
        object sgSpotSymbols: TStringGrid
          Left = 0
          Top = 0
          Width = 243
          Height = 639
          ...
          TabOrder = 0
          OnMouseDown = sgFuturesMouseDown
          ColWidths = (
            162
            42)
        end
  ...
  object PanelMain: TPanel
    ...
    object PanelTop: TPanel
      ...
      object udControl: TUpDown
        ...
        Min = -100
        TabOrder = 1
        OnClick = udControlClick
        ExplicitLeft = 563
      end
      object btnAllCnl: TButton
        Left = 294
        Top = 11
        Width = 81
        Height = 30
  ...
  object batchCnl: TTimer
    Enabled = False
    Interval = 200
    OnTimer = batchCnlTimer
    Left = 168
    Top = 688
  end
  object tmPriceSort: TTimer
    Enabled = False
    OnTimer = tmPriceSortTimer
    Left = 108
    Top = 692
  end
  object tmExpect: TTimer
    Enabled = False
    OnTimer = tmExpectTimer
    Left = 36
    Top = 684
  end
end
