...
const
  ...
  ZERO_EPSILON :   Double = 0.000000001;

  SCALE = 100000000;  // 8자리 (소수점 이하 정밀도)

  GRID_MOD_COLOR = $F8F8F8;
  SELECTED_COLOR  = $00F2BEB9;
  EDIT_COL_COLOR  = $00E6FFE6;
  ...
  TAppStatusDesc : array [ TAppStatus ] of string = ('None', 'Init', 'SetValue', 'Recovery', 'Load', 'Show', 'Close');
  TAutoOrderTypeDesc : array [TAutoOrderType] of string = ('Entry', 'Exit');
  TSideTypeDesc : array [TSideType] of string  = ('매수','매도');
