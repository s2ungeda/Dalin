...
uses
  ...
  USharedManager, UStrategyManager, UDBManager
  ;
...
type
  ...
  private
    ...
    FStgManager: TStrategyManager;
    FDBManager: TSQLiteManager;
  ...
  public
    ...
    property StgManager: TStrategyManager read FStgManager;
    ...
    property DBManager : TSQLiteManager read FDBManager;
...
begin
  ...
  FDBManager    := TSQLiteManager.Create;

  FStgManager   := TStrategyManager.Create;
